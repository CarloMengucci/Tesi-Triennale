...
\caption{\textit{In figura è rappresentato il best fit per l'intera popolazione, rappresentato dalla retta in rosso, successivamente troncata in modo da interpolare i soli valori presenti nell'intervallo $-2<y<2$, rappresentato dalla zona arancione nello scatterplot.
