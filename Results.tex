...
Nella prossima sezione saranno valutati gli effetti quantificati in questo capitolo in relazione all'applicazione di dati biologici reali.

In questo modo sarà possibile proporre una soluzione al problema dell'utilizzo dei metodi di classici tramite confronto, cercando dei metodi che forniscano performance predittive migliori cercando di mantenere una certa semplicità operativa.
