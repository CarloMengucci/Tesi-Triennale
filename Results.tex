...
\section{Interpolazioni Lineari e Metodi di Maximum Likelyhood}
...
L'ipotesi che i residui seguano una distribuzione normale, fa sì che i minimi quadrati coincidano esattamente con la funzione di \textit{maximum likelyhood} risolta \textit{analiticamente} per il caso lineare.
...
\subsection{Maximum Likelyhood per Distribuzioni Normali Troncate}
