...
\marginnote{qui spiegherei che il caso che studiamo è quello di dati mancanti non random (\url{https://en.wikipedia.org/wiki/Missing_data}). Il problema è che in questo caso mancano tutti i dati al di fuori dell'intervallo, ed è questo che distorce i nostri risultati. Questo succede ogni volta in cui la mancanza di un dato è associata al suo valore, sia per ragioni sperimentali che di design.}
...
Econometrica, Novembre 1976,Volume 41, Numero 6
